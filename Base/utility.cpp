...
void fill_range(value_type * begin, value_type * end, value_type & const value) {
	for (value_type * iterator; iterator != end; ++iterator) {
		*iterator = value;
	}
}
// fill matrix
